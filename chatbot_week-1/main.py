...
<div style="text-align: center; padding: 2rem 0;">
    ...
    <p style="font-size: 1.2rem; color: #666; margin-bottom: 2rem;"> Your intelligence Document Assistant</p>
</div>
""", unsafe_allow_html=True)
...
# Main chat interface
st.markdown("### Chat with About Your Documents")
    ...
    if st.session_state.vectorstore and st.session_state.chat_model:
        with st.chat_message("assistant"):
            with st.spinner("Searching documents..."):
                ...
                system_prompt = f"""You are Chat Pro, an intelligent document assistant. Based on the following documents, provide accurate and helpful answers.
